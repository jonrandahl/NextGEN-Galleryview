<?php
/**
NextGEN-Galleryview Lazyload Template
...
<div id="<?php echo $gallery->anchor; ?>" class="galleryview">
    <ul class="<?php echo $gallery->anchor; ?>">
  	<?php foreach ($images as $image) : ?>
      	...
      	<img class="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/images/grey.gif" data-original="<?php echo $image->imageURL;  ?>" alt="<?php echo $image->alttext; ?>" data-description="<?php echo $image->description; ?>" title="<?php echo $image->alttext; ?>" <?php echo $image->size; ?>  />
        <noscript><img src="<?php echo $image->imageURL;  ?>" alt="<?php echo $image->alttext; ?>" data-description="<?php echo $image->description; ?>" title="<?php echo $image->alttext; ?>" <?php echo $image->size; ?>  />></noscript>
      </li>
	<?php endforeach; ?>
  	</ul>
</div>
